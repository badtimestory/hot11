...
<body>
	...
	<form action="./update" method="post" id="frm">
		...
		<fieldset>
			<legend>ID</legend>
			<input type="text" name="m_id" id="id" value="${member.m_id}"
				readonly="readonly">
			<div id="idResult"></div>
		</fieldset>
		...
		<fieldset>
			<legend>Phone</legend>
			<input type="text" name="m_phone" placeholder="숫자만 입력해주세요."
				value="${member.m_phone}" id="phone">
		</fieldset>

		<fieldset>
			<legend>Email</legend>
			<input type="text" name="m_email" placeholder="ex)id@gmail.com"
				value="${member.m_email}" id="email">
		</fieldset>
